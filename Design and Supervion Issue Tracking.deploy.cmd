...
set _DeploySetParametersFile=%RootPath%Design and Supervion Issue Tracking.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%Design and Supervion Issue Tracking.zip" (
echo "%RootPath%Design and Supervion Issue Tracking.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%Design and Supervion Issue Tracking.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%Design and Supervion Issue Tracking.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%Design and Supervion Issue Tracking.deploy-readme.txt" (
...
start notepad "%RootPath%Design and Supervion Issue Tracking.deploy-readme.txt"
)
echo =========================================================
goto :eof
